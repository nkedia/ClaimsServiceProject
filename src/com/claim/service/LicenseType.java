...
@XmlType(name = "licenseType", namespace = "localhost:8080/ClaimsService/driverDetails", propOrder = {
    "licenseNo",
    "issuingRTO",
    "effectiveFrom",
    "expiryDate",
...
public class LicenseType {
    ...
    @XmlElement(name = "class", namespace = "localhost:8080/ClaimsService/driverDetails", required = true)
